...
def create_ground_truth(path, start=0, end=0, 
    ...
    for bagtopic, msg, t in bag.read_messages():
        ...
        msgs.append({ 'time': stamp, 'trans': msg.transform.translation, 'orien': msg.transform.rotation})
    ...
    with open(file, 'w') as f:
        ...
        f.write('Timestamp [s]\tTranslation X [m]\tTranslation Y [m]\tTranslation Z [m]\tOrientation W\tOrientation X\tOrientation Y\tOrientation Z\n')
        for msg in msgs:
            f.write('%.6f\t' % msg['time'])
...
if __name__ == '__main__':
    ...
    gt_command = gt.add_subparsers(help='Analyze the ground truth data', dest='command')
